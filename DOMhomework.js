...
// Tu código acá:
let creadoX = document.querySelector ("#createdBy")
creadoX.textContent = "Aplicación creada por Brandon"
...
// classname asigna la variable. Averigua que significa 
// EN ESTA FUNCION CREAS TODO HTML.


function buildToDo(todo, index) {
  // Tu código acá:
  let toDoShell = document.createElement("div");
    toDoShell.className = 'toDoShell'; //aquí nos fuimos al apartado style.css del documento y en razón de él se agrega este toDoShell, pero no entiendia por qué. Creo haber entendido, el style.css contiene clases que marcan estilos, así se los agrego.
